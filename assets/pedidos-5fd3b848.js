import { s as supabase } from "./main-e0161a73.js";
class Pedidos {
  ...
  static async getAllByPerfilId(id) {
    ...
    return pedido.map(({ id: id2, numeroPedido, created_at, id_coche, id_perfil }) => {
      return new Pedidos(id2, numeroPedido, created_at, id_coche, id_perfil);
    });
  }
